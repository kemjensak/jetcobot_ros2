...
def get_robot_description_semantic():
    robot_description_semantic_config = load_file(
        "jetcobot_moveit_config", "config/jetcobot.srdf"
    )
...
def generate_common_hybrid_launch_description():
    ...
    kinematics_yaml = load_yaml(
        "jetcobot_moveit_config", "config/kinematics.yaml"
    )

    joint_limits_yaml = load_yaml(
        "jetcobot_moveit_config", "config/joint_limits.yaml"
    )
    ...
    ompl_planning_yaml = load_yaml(
        "jetcobot_moveit_config", "config/ompl_planning.yaml"
    )
    ...
    common_hybrid_planning_param = load_yaml(
        "jetcobot_moveit_config", "config/common_hybrid_planning_params.yaml"
    )
    global_planner_param = load_yaml(
        "jetcobot_moveit_config", "config/global_planner.yaml"
    )
    local_planner_param = load_yaml(
        "jetcobot_moveit_config", "config/local_planner.yaml"
    )
    hybrid_planning_manager_param = load_yaml(
        "jetcobot_moveit_config", "config/hybrid_planning_manager.yaml"
    )
    ...
    jetcobot_joint_group_position_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=[
    ...
    launched_nodes = [
        ...
        jetcobot_joint_group_position_controller_spawner,
    ]
